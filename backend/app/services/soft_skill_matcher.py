...
_SOFT_SKILL_CUES: Dict[str, List[str]] = {
    "communication": [r"\bcommunicat", r"\bpresented\b", r"\bpresentation", r"\bauthored\b", r"\bdocument", r"\barticulat"],
    "leadership": [r"\blead", r"\bled\b", r"\bmanaged\b", r"\bmentore?d?\b", r"\bheaded\b", r"\bspearheaded\b", r"\bcaptain\b", r"\bpresident\b", r"\bcoordinat"],
    "teamwork": [r"\bteams?\b", r"\bteamwork\b", r"\bcollaborat", r"\bcross[- ]functional\b"],
    "collaboration": [r"\bcollaborat", r"\bpartnered\b", r"\bworked with\b"],
    "problem solving": [r"\bproblem", r"\bsolved\b", r"\bresolv", r"\bdebug", r"\boptimiz", r"\btroubleshoot"],
    ...
    "presentation skills": [r"\bpresent", r"\bpresentation", r"\bdemo\b", r"\bshowcase"],
    "time management": [r"\btime management\b", r"\bdeadline", r"\bprioritiz", r"\bschedul"],
    ...
    "attention to detail": [r"\battention to detail\b", r"\bmeticulous\b", r"\baccuracy\b", r"\bthorough\b"],
    ...
    "ownership": [r"\bowned\b", r"\bownership\b", r"\bresponsible for\b", r"\bend[- ]to[- ]end\b"],
}
_SOFT_SKILL_CUES = {k: [re.compile(p, re.I) for p in v] for k, v in _SOFT_SKILL_CUES.items()}
...
def match_soft_skills(jd_keywords: List[str], resume_text: str) -> List[str]:
    ...
    for keyword in jd_keywords:
        ...
        elif re.search(r"\b" + re.escape(key) + r"\b", resume_text, re.I):  # unknown keyword, literal
            matched.append(keyword)
    return matched